...
<img src="https://see.fontimg.com/api/rf5/x3J88/ZWE0MjI4NDJjYTkzNGUwN2E4NTA5ZTJhMDY0ZmNkNmYudHRm/TW9yZSBDb21wbGV4IEFwcGxpY2F0aW9ucw/magnific-chaos-personal-use-regular.png?r=fs&h=80&w=1000&fg=9413B3&bg=FFFFFF&tb=1&s=80">
 ...
 | Project | Preview |
 |:---------:|:---------:|
|<h4>CreateIT:</h4>A cost-effective mobile application prototype designed to help users manage their spending while enjoying their favorite cuisines. Built using C#, the app integrates various food store APIs to provide features such as recipe suggestions and ingredient lists. Additionally, it incorporates a local database for user authentication to ensure seamless and secure access.|<a href="https://github.com/PassionOverPain/CreateTech" title="CreateIT" ><img src="https://github.com/user-attachments/assets/5d00303f-ef0a-40e7-b66c-2a5964f05c00?raw=true" height=100px ></a>|
